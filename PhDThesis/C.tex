...
In order to evaluate the devices in closed-loop, the models should also be simple enough so that they can be used for model checking and interact with device implementations in real-time.

In this chapter, an EP heart model structure is developed for closed-loop evaluation of implantable cardiac devices. 
The heart model structure is capable of representing a large variety of heart conditions and its parameters can be identified from patient data.
